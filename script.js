...
var APPS = {
    'cine': {title: 'PO // HUB', path: 'script/Apps/Cine/index.html', icon: 'https://cdn.worldvectorlogo.com/logos/netflix-logo-icon.svg', pinned: true},
    ...
    'ciniai': {title: 'PO AI', path: 'script/Apps/Cini/index.html', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkLXhvns5Rrdf-XBNlWcPIRh0hlJfWnEtBWg&s', pinned: false},
...
var wallpaperRegistry = {
    ...
    "55Cine": {id: "55Cine", name: "PO 55", url: "Videos/55Cine.PNG", locked: false},
